...
function hasMinVersion(minVersion, runtimeVersion) {
  ...
  if (!runtimeVersion) return true; // semver.intersects() has some surprising behavior with comparing ranges
