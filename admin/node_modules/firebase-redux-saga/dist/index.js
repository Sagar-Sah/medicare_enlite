...
var ReduxSagaFirebase = /*#__PURE__*/function () {
  function ReduxSagaFirebase(firebaseApp) {
    ...
    this.auth = {
      ...
      updateProfile: _auth["default"].updateProfile.bind(this)
    }; // Database methods
    ...
    this.database = {
      ...
      sync: _database["default"].sync.bind(this)
    }; // Firestore methods
    ...
    this.firestore = {
      ...
      updateDocument: _firestore["default"].updateDocument.bind(this)
    }; // Functions methods

    this.functions = {
      call: _functions["default"].call.bind(this)
    }; // Messaging methods
    ...
    this.messaging = {
      ...
      tokenRefreshChannel: _messaging["default"].tokenRefreshChannel.bind(this)
    }; // Storage methods
